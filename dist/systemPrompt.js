...
const PROMPT = 'Compress this AI assistant system prompt to under 600 tokens. ' +
...
export async function compressSystemPrompt(prompt, apiKey, backend) {
    ...
    try {
        ...
        if (backend === 'haiku') {
            ...
            compressed = resp.content[0].text;
        }
